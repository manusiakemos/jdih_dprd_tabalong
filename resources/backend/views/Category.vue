    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <data-tables :url="configDt.url" :columns="configDt.columns" selector="dt-Kategori"
                                     ref="dt"></data-tables>
                    </div>
                </div>
                <!-- end-datatables -->
    ...
    export default {
        ...
        methods: {
            ...
            create() {
                ...
                this.action = "store";
                this.titleForm = "Tambah Kategori";
